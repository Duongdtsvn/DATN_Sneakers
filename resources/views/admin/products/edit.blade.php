    ...
    <div class="container-xxl">
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.products.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">                                
                                    ...
                                    <div class="mb-3">
                                        <label for="example-email" class="form-label"><strong>Giá khuyến mại</strong></label>
                                    ...
                                    <div class="mb-3">
                                        <label for="example-password" class="form-label"><strong>Trạng thái</strong></label>
            ...
            == $item->id ? 'selected' : '' }}>
                                    ...
                                    <div class="mb-3">
                                        <label for="mo_ta_ngan" class="form-label"><strong>Description</strong></label> <br>
